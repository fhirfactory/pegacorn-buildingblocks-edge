package net.fhirfactory.pegacorn.platform.restfulapi.resourcespecific;
...
public class ProcedureSearches {
    ...
    public Bundle getProceduresWithSubjectAndDate(PegacornInternalFHIRClientServices accessor, Map<Property, Serializable> parameterSet) {
    ...
    public Bundle getProceduresWithSubjectAndDate(PegacornInternalFHIRClientServices accessor, String subjectIdentifierSystem, String subjectIdentifierTypeCode, String subjectIdentifierValue, Date startDate, Date endDate){
    ...
    public Bundle getProceduresWithSubjectAndDate(PegacornInternalFHIRClientServices accessor, Identifier identifier, DateRangeParam dateRangeParam){
        String identifierTypeCode = null;
